...
t.add("fos_user.username.already_used", "Uporabni\u0161ko ime \u017ee obstaja.", "validators", "sl");
t.add("fos_user.username.blank", "Prosimo, vnesite uporabni\u0161ko ime.", "validators", "sl");
t.add("fos_user.username.short", "Uporabni\u0161ko ime je prekratko.", "validators", "sl");
t.add("fos_user.username.long", "Uporabni\u0161ko ime je predolgo.", "validators", "sl");
t.add("fos_user.email.already_used", "Email \u017ee obstaja.", "validators", "sl");
t.add("fos_user.email.blank", "Prosimo, vnesite email.", "validators", "sl");
t.add("fos_user.email.short", "Email je prekratek.", "validators", "sl");
t.add("fos_user.email.long", "Email je predolg.", "validators", "sl");
t.add("fos_user.email.invalid", "Email je napa\u010den.", "validators", "sl");
t.add("fos_user.password.blank", "Prosimo, vnesite geslo.", "validators", "sl");
t.add("fos_user.password.short", "Geslo je prekratko.", "validators", "sl");
t.add("fos_user.password.mismatch", "Vpisani gesli se ne ujemata.", "validators", "sl");
t.add("fos_user.new_password.blank", "Prosimo, vnesite novo geslo.", "validators", "sl");
t.add("fos_user.new_password.short", "Novo geslo je prekratko.", "validators", "sl");
t.add("fos_user.current_password.invalid", "Geslo je napa\u010dno.", "validators", "sl");
t.add("fos_user.group.blank", "Prosimo, vnesite ime.", "validators", "sl");
t.add("fos_user.group.short", "Ime je prekratko.", "validators", "sl");
t.add("fos_user.group.long", "Ime je predolgo.", "validators", "sl");
t.add("fos_group.name.already_used", "Ime je \u017ee v uporabi.", "validators", "sl");
})(Translator);
