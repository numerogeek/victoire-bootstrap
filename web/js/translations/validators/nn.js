...
t.add("The value you selected is not a valid choice.", "Verdien du valgte er ikkje gyldig.", "validators", "nn");
t.add("You must select at least {{ limit }} choice.|You must select at least {{ limit }} choices.", "Du m\u00e5 velge minst {{ limit }} valg.", "validators", "nn");
t.add("You must select at most {{ limit }} choice.|You must select at most {{ limit }} choices.", "Du kan maksimalt gjere {{ limit }} valg.", "validators", "nn");
t.add("One or more of the given values is invalid.", "Ein eller fleire av dei opplyste verdiane er ugyldige.", "validators", "nn");
t.add("This field was not expected.", "Dette feltet var ikke forventet.", "validators", "nn");
...
t.add("The file could not be found.", "Fila kunne ikkje finnes.", "validators", "nn");
t.add("The file is not readable.", "Fila kan ikkje lesast.", "validators", "nn");
t.add("The file is too large ({{ size }} {{ suffix }}). Allowed maximum size is {{ limit }} {{ suffix }}.", "Fila er for stor ({{ size }} {{ suffix }}). Tillatt maksimal st\u00f8rrelse er {{ limit }} {{ suffix }}.", "validators", "nn");
t.add("The mime type of the file is invalid ({{ type }}). Allowed mime types are {{ types }}.", "Mime-typen av fila er ugyldig ({{ type }}). Tillatte mime-typar er {{ types }}.", "validators", "nn");
...
t.add("This value should not be blank.", "Verdien m\u00e5 ikkje vere blank.", "validators", "nn");
t.add("This value should not be null.", "Verdien m\u00e5 ikkje vere tom (null).", "validators", "nn");
...
t.add("This value is not a valid time.", "Verdien er ikkje gyldig tidseining.", "validators", "nn");
...
t.add("The file is too large. Allowed maximum size is {{ limit }} {{ suffix }}.", "Fila er for stor. Den maksimale storleik er {{ limit }} {{ suffix }}.", "validators", "nn");
...
t.add("The image width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.", "Biletbreidda er for stor, ({{ width }} pikslar). Tillatt maksimumsbreidde er {{ max_width }} pikslar.", "validators", "nn");
...
t.add("The image height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.", "Bileth\u00f8gda er for stor, ({{ height }} pikslar). Tillatt maksimumsh\u00f8gde er {{ max_height }} pikslar.", "validators", "nn");
...
t.add("The file was only partially uploaded.", "Fila vart kun delvis opplasta.", "validators", "nn");
...
t.add("Unsupported card type or invalid card number.", "Korttypen er ikkje st\u00f8tta eller ugyldig kortnummer.", "validators", "nn");
})(Translator);
