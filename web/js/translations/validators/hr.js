...
t.add("fos_user.username.already_used", "Korisni\u010dko ime ve\u0107 postoji.", "validators", "hr");
t.add("fos_user.username.blank", "Molimo, unesite korisni\u010dko ime.", "validators", "hr");
t.add("fos_user.username.short", "Korisni\u010dko ime je prekratko.", "validators", "hr");
t.add("fos_user.username.long", "Korisni\u010dko ime je predugo.", "validators", "hr");
t.add("fos_user.email.already_used", "Email ve\u0107 postoji.", "validators", "hr");
t.add("fos_user.email.blank", "Molimo, unesite email.", "validators", "hr");
t.add("fos_user.email.short", "Email je prekratak.", "validators", "hr");
t.add("fos_user.email.long", "Email je predug.", "validators", "hr");
t.add("fos_user.email.invalid", "Email nije ispravan.", "validators", "hr");
t.add("fos_user.password.blank", "Molimo, unesite lozinku.", "validators", "hr");
t.add("fos_user.password.short", "Lozinka je prekratka.", "validators", "hr");
t.add("fos_user.new_password.blank", "Molimo, unesite novu lozinku.", "validators", "hr");
t.add("fos_user.new_password.short", "Nova lozinka je prekratka.", "validators", "hr");
t.add("fos_user.current_password.invalid", "Lozinka nije ispravna.", "validators", "hr");
t.add("fos_user.group.blank", "Molimo unesite naziv.", "validators", "hr");
t.add("fos_user.group.short", "Naziv je prekratak.", "validators", "hr");
t.add("fos_user.group.long", "Naziv je predug.", "validators", "hr");
t.add("fos_group.name.already_used", "To se ime ve\u0107 upotrebljava.", "validators", "hr");
})(Translator);
