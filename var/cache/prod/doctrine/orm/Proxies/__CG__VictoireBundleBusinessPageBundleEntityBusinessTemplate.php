...
namespace Proxies\__CG__\Victoire\Bundle\BusinessPageBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class BusinessTemplate extends \Victoire\Bundle\BusinessPageBundle\Entity\BusinessTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BusinessTemplate $proxy) {
