...
namespace Proxies\__CG__\Victoire\Bundle\TwigBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ErrorPage extends \Victoire\Bundle\TwigBundle\Entity\ErrorPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'code', 'translations', 'id', 'bodyId', 'bodyClass', 'widgetMaps', 'parent', 'position', 'lft', 'lvl', 'rgt', 'root', 'children', 'author', 'undeletable', 'references', 'template', 'cssHash', 'cssUpToDate', 'roles', 'builtWidgetMap', 'createdAt', 'updatedAt', 'newTranslations', 'currentLocale', 'defaultLocale'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ErrorPage $proxy) {
