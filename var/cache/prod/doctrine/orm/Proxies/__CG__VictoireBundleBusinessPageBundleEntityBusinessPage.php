 ...
 */
class BusinessPage extends \Victoire\Bundle\BusinessPageBundle\Entity\BusinessPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'entityProxy', 'businessEntity', 'translations', 'id', 'bodyId', 'bodyClass', 'widgetMaps', 'parent', 'position', 'lft', 'lvl', 'rgt', 'root', 'children', 'author', 'undeletable', 'references', 'template', 'cssHash', 'cssUpToDate', 'roles', 'builtWidgetMap', 'createdAt', 'updatedAt', 'newTranslations', 'currentLocale', 'defaultLocale', 'seo', 'referers', 'status', 'publishedAt', 'homepage'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BusinessPage $proxy) {
