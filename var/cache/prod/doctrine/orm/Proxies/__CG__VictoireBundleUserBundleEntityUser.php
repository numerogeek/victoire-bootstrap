...
namespace Proxies\__CG__\Victoire\Bundle\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Victoire\Bundle\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'firstname', 'lastname', 'locale', 'heartbeat', 'pages', 'articles', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles', 'createdAt', 'updatedAt'];
        }
    ...
    public function getHeartbeat()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHeartbeat', []);

        return parent::getHeartbeat();
    }
    ...
    public function setHeartbeat($heartbeat)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHeartbeat', [$heartbeat]);

        return parent::setHeartbeat($heartbeat);
    }
