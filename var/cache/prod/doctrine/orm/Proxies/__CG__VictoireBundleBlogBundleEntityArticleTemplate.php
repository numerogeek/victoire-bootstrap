 ...
 */
class ArticleTemplate extends \Victoire\Bundle\BlogBundle\Entity\ArticleTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'seo', 'inheritors', 'backendName', 'layout', 'translations', 'id', 'bodyId', 'bodyClass', 'widgetMaps', 'parent', 'position', 'lft', 'lvl', 'rgt', 'root', 'children', 'author', 'undeletable', 'references', 'template', 'cssHash', 'cssUpToDate', 'roles', 'builtWidgetMap', 'createdAt', 'updatedAt', 'newTranslations', 'currentLocale', 'defaultLocale', 'query', 'orderBy', 'businessEntityId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArticleTemplate $proxy) {
    ...
    public function additionnalQueryPart()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'additionnalQueryPart', []);

        return parent::additionnalQueryPart();
    }
    ...
    public function setInstances($inheritors)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInstances', [$inheritors]);

        return parent::setInstances($inheritors);
    }
