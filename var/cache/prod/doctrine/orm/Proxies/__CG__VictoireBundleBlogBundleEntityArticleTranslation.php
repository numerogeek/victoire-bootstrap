 ...
 */
class ArticleTranslation extends \Victoire\Bundle\BlogBundle\Entity\ArticleTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'slug', '' . "\0" . 'Victoire\\Bundle\\BlogBundle\\Entity\\ArticleTranslation' . "\0" . 'image', '' . "\0" . 'Victoire\\Bundle\\BlogBundle\\Entity\\ArticleTranslation' . "\0" . 'description', 'id', 'locale', 'translatable'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArticleTranslation $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setImage(\Victoire\Bundle\MediaBundle\Entity\Media $image = NULL)
    {
